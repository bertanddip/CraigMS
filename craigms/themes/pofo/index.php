...
<div id="header-wrapper">
    ...
    <div id="header">
		...
		<div id="nav">
            <?php $_GET['id'] = '2'; include('craigms/includes/single-html.php'); ?>
        </div><!--- end nav --->
        <div id="social">
...
<div id="wrapper">
	...
	<div id="slideshow">
        <img src="<?php $_GET['id'] = '10'; include('craigms/includes/single-image.php'); ?>" alt="Slideshow Image 1" class="active" />
        <img src="<?php $_GET['id'] = '11'; include('craigms/includes/single-image.php'); ?>" alt="Slideshow Image 2" />
	</div>

    <div id="content">
    <?php $_GET['id'] = '2'; include('craigms/includes/single-html.php'); ?>
        <?php $_GET['id'] = '3'; include('craigms/includes/single-text.php'); ?>
